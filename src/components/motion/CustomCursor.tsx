...
export function CustomCursor() {
  ...
  useGSAP(() => {
    ...
    const handleOver = (e: MouseEvent) => {
      ...
      if (target.closest(FIELD_SELECTOR)) {
        ...
        gsap.to(cursor, { scale: 1.25, rotate: -10, duration: 0.3, ease: "back.out(2)" });
      }
    };
    ...
    const handleOut = (e: MouseEvent) => {
      ...
      if (target.closest(FIELD_SELECTOR)) {
        ...
        gsap.to(cursor, { scale: 1, rotate: 0, duration: 0.3, ease: "back.out(2)" });
      }
    };
  ...
  return (
    <div
      ...
      aria-hidden
    >
      {/* Offsets the icon so its tip (not its center) sits at the pointer position. */}
      <div className="h-8 w-8 translate-x-[-35%] translate-y-[-21%] drop-shadow-md">
        <svg viewBox="0 0 512.001 512.001" className="h-full w-full">
          <polygon
            fill="#CEE8FA"
          ...
          <path
            fill="#2D527C"
            d="M459.05,336.218L184.096,101.342c-4.19-3.579-10.07-4.425-15.1-2.167
	...
	l224.453,191.737L292.434,339.395z"
          ...
          <path
            fill="#2D527C"
            d="M151.711,73.797c-5.451,0-10.655-3.143-13.025-8.439l-18.968-42.397
	...
	C155.635,73.394,153.656,73.797,151.711,73.797z"
          ...
          <path
            fill="#2D527C"
            d="M105.605,122.549c-1.691,0-3.409-0.302-5.084-0.943l-43.391-16.565
	...
	c7.358,2.809,11.044,11.051,8.235,18.408C116.759,119.054,111.346,122.549,105.605,122.549z"
          ...
          <path
            fill="#2D527C"
            d="M267.528,118.012c-5.451,0-10.655-3.143-13.025-8.439c-3.217-7.188,0.003-15.624,7.193-18.84
	...
	C271.453,117.612,269.475,118.012,267.528,118.012z"
          ...
          <path
            fill="#2D527C"
            d="M65.099,208.582c-5.451,0-10.655-3.141-13.025-8.439c-3.217-7.19,0.003-15.624,7.193-18.84
	...
	C69.023,208.181,67.046,208.582,65.099,208.582z"
          ...
          <path
            fill="#2D527C"
            d="M218.766,71.919c-1.691,0-3.41-0.302-5.084-0.943c-7.358-2.809-11.044-11.051-8.235-18.408
